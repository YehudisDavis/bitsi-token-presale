...
export default async function HomePage() {
  ...
  return (
    <main className="w-full">
      ...
      {/* Hero text */}
      <section className="max-w-[1087px] mx-auto pt-4 text-center">
        <h1 className="font-poppins font-bold text-white leading-[1.2] mb-2" style={{ fontSize: 'clamp(32px, 3.65vw, 63px)' }}>
      ...
      {/* Our Partners */}
      <p className="font-poppins text-white leading-[1.2] text-center mb-2" style={{ fontSize: 'clamp(18px, 1.74vw, 30px)' }}>Our Partners</p>
      <div className="w-full px-[9%] flex items-center justify-between pb-4 flex-wrap gap-4">
